...
#define WIFI_ENTERPRISE_SECURITY_COMMANDS \
        { (char*) "join_ent", join_ent, 0, NULL, NULL, (char*) "<ssid> <eap_tls|peap|eap_ttls> [username] [password] <wpa_aes|wpa_mixed|wpa2_aes|wpa2_mixed|wpa3_aes_ccmp|wpa3_aes_gcm>", (char*) "Join an AP using an enterprise EAP method. DHCP assumed."}, \
